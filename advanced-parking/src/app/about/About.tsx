	...
	return (
		<div className='2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 pt-24 px-4 dark:text-ghostwhite'>
			<div className='flex flex-col lg:flex-row justify-between gap-8 dark:text-ghostwhite'>
				...
				<div className='w-full lg:w-6/12 pt-10 flex items-center justify-center dark:text-ghostwhite'>
			...
			<div>
				<h2 className='text-3xl lg:text-5xl font-extrabold leading-9 text-erieblack dark:text-ghostwhite'>Resources</h2>
			...
			<div className='flex lg:flex-row flex-col justify-between gap-8 pt-12'>
				<div className='w-full lg:w-5/12 flex flex-col justify-center'>
					<h2 className='text-3xl lg:text-5xl font-extrabold leading-9 text-erieblack pb-4 dark:text-ghostwhite'>Meet the brains</h2>
					<p className='font-medium text-base leading-6 text-erieblack dark:text-ghostwhite'>
					...
					<p className='font-medium text-base leading-6 text-erieblack pt-2 dark:text-ghostwhite'>
						You can find us on our LinkedIn profile or you can go to{' '}
						<Link href='/contact' className='text-erieblack font-extrabold underline decoration-silver dark:text-ghostwhite'>
							Contact
						</Link>{' '}
						and send us a message.
					</p>
				</div>
				<div className='w-full lg:w-8/12 lg:pt-8 rounded-lg dark:text-ghostwhite shadow-lg shadow-silver/30 mb-4 sm:mb-0'>
					<div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md dark:text-ghostwhite'>
						<Link target='_blank' href='https://www.linkedin.com/in/gabriel-gotlib-5855197b/' className='p-4 pb-6 flex justify-center flex-col items-center'>
							...
							<p className='font-medium text-base leading-5 text-gray-800 mt-4 dark:text-ghostwhite'>Gabriel Gotlib</p>
						</Link>
						<Link target='_blank' href='https://www.linkedin.com/in/mlmarce/' className='p-4 pb-6 flex justify-center flex-col items-center'>
							...
							<p className='font-medium text-base leading-5 text-gray-800 mt-4 dark:text-ghostwhite'>Marcelo Lencina</p>
						</Link>
						<Link target='_blank' href='https://www.linkedin.com/in/sim%C3%B3n-salas-seeber-138112144/' className='p-4 pb-6 flex justify-center flex-col items-center'>
							...
							<p className='font-medium text-base leading-5 text-gray-800 mt-4 dark:text-ghostwhite'>Simón Salas</p>
						</Link>
						<Link target='_blank' href='https://www.linkedin.com/in/mario-gutierrez-tello/' className='p-4 pb-6 flex justify-center flex-col items-center'>
							...
							<p className='font-medium text-base leading-5 text-gray-800 mt-4 dark:text-ghostwhite'>Mario Gutiérrez</p>
						</Link>
						<Link target='_blank' href='https://www.linkedin.com/in/jose-salvador-coledani-grillo-10b857278/' className='p-4 pb-6 flex justify-center flex-col items-center'>
							...
							<p className='font-medium text-base leading-5 text-gray-800 mt-4 dark:text-ghostwhite'>Jose Coledani</p>
						</Link>
						<Link target='_blank' href='https://www.linkedin.com/in/sebastianibarguen/' className='p-4 pb-6 flex justify-center flex-col items-center'>
							...
							<p className='font-medium text-base leading-5 text-gray-800 mt-4 dark:text-ghostwhite'>Sebastian Ibargüen</p>
						</Link>
					</div>
				</div>
			</div>
