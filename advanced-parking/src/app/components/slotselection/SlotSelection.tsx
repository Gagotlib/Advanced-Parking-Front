        ...
        <div className='grid h-3/4 grid-cols-3 mt-4 mx-2'>
          <div className='flex flex-col gap-1'>
            {floor1.map((slot, index) => (
              <div
                key={index + 1}
                className={clsx('w-[100px] p-2 border border-dashed border-r-0 rounded-md border-erieblack bg-silver/50 hover:cursor-pointer ', {
          ...
          <div className='flex flex-col gap-1 '>
            {floor2.map((slot, index) => (
              <div
                key={index + 6}
                className={clsx('w-[100px] p-2 border border-dashed rounded-md border-l-0 border-erieblack bg-silver/50 hover:cursor-pointer', {
