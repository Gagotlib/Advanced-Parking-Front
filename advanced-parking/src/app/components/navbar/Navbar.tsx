...
function Navbar() {
	...
	return (
		<nav className='bg-duck-yellow shadow-xl'>
			<div className='max-w-screen-xl flex items-center justify-between mx-auto p-4'>
				<Link href='' className='flex items-center'>
					<Image src='/logo_advanced_parking.jpg' className='' alt='Advanced_Parking Logo' width={60} height={60} priority={true} />
				...
				{/* VALIDAR {navOpen &&
					<div className='z-20 filter blur-sm'></div>}  */}
				<div className={`items-center ${navOpen ? '' : 'hidden'} justify-between w-full md:flex md:w-auto md:order-1 fixed top-16 right-0 z-50 bg-duck-yellow `} id='navbar-user'>
